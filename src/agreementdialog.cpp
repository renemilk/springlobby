...
AgreementDialog::AgreementDialog(wxWindow* parent, const wxString& agreement)
  ...
  m_text = new wxTextCtrl(this, wxID_ANY, RTFtoText(agreement), wxDefaultPosition, wxDefaultSize,
                          wxTE_MULTILINE | wxTE_RICH | wxTE_WORDWRAP);
  m_main_sizer->Add(m_text, 1, wxALL | wxEXPAND, 5);

  m_accept_lbl = new wxStaticText(this, wxID_ANY, _("Do you accept the terms of this agreement?"), wxDefaultPosition,
                                  wxDefaultSize, 0);
...
void AgreementDialog::OnYes(wxCommandEvent& /*unused*/) { EndModal(1); }

void AgreementDialog::OnNo(wxCommandEvent& /*unused*/) { EndModal(0); }
