...
public:
  ...
  void SetMenuItemId(int n) { m_nMenuId = n; }

  int GetMenuItemId() { return m_nMenuId; }
};
...
public:
  ...
  int GetID(size_t n) const { return m_arrID[n]; }
  ...
  void SetID(size_t n, int id) { m_arrID[n] = id; }
};
