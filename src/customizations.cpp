...
const LSL::OptionsWrapper& Customizations::GetCustomizations() const { return m_customs; }

/** @brief GetAppIcon
  *
  * @todo: document this function
  */
const wxIconBundle& Customizations::GetAppIconBundle() const { return m_app_icons; }

/** @brief GetHelpUrl
  *
  * @todo: document this function
  */
const wxString& Customizations::GetHelpUrl() const { return m_help_url; }

/** @brief GetModname
  *
  * @todo: document this function
  */
const wxString& Customizations::GetModname() const { return m_modname; }

const wxString& Customizations::Archive() const { return m_archive; }
...
bool Customizations::Active() const { return m_active; }
...
wxString Customizations::GetIntroText() const {
  ...
  return TowxString(
      LSL::usync().GetTextfileAsString(STD_STRING(m_archive), m_customs.getSingleValue(STD_STRING(IntroKey))));
}
