...
ActivityNoticePanel::ActivityNoticePanel(wxWindow* parent, const wxString& notice, const wxSize& panel_size,
                                         const wxSize& gauge_size)
...
void ActivityNoticePanel::OnTimer(wxTimerEvent&) { m_gauge->Pulse(); }
...
ActivityNoticeContainer::~ActivityNoticeContainer() { m_window->Destroy(); }
