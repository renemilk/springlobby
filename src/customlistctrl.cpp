...
CustomListCtrl::CustomListCtrl(wxWindow* parent, wxWindowID id, const wxPoint& pt, const wxSize& sz, long style,
                               wxString name, unsigned int column_count, bool highlight,
                               UserActions::ActionType hlaction)
...
void CustomListCtrl::ResetSelection() { m_selected = m_prev_selected = m_prev_selected_index = m_selected_index = -1; }
...
long CustomListCtrl::GetSelectedIndex() { return m_selected_index; }
...
void CustomListCtrl::SetSelectedIndex(const long newindex) { m_selected_index = newindex; }

long CustomListCtrl::GetSelectedData() { return m_selected; }
...
void CustomListCtrl::SetHighLightAction(UserActions::ActionType action) { m_highlightAction = action; }

void CustomListCtrl::MarkDirtySort() { m_dirty_sort = true; }

void CustomListCtrl::CancelTooltipTimer() { m_tiptimer.Stop(); }
