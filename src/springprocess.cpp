...
void SpringProcess::SetCommand(const wxString& cmd) { m_cmd = cmd; }
...
wxSpringProcess::wxSpringProcess(Spring& sp) : m_sp(sp) { wxLogDebugFunc(_T( "" )); }

wxSpringProcess::~wxSpringProcess() { wxLogDebugFunc(_T( "" )); }
