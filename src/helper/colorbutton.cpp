...
ColorButton::ColorButton(wxWindow* parent, wxWindowID id, const wxBitmap& bitmap, const wxPoint& pos,
...
ColorButton::ColorButton(wxWindow* parent, wxWindowID id, const wxColour& color, const wxPoint& pos, const wxSize& size,
...
wxColour ColorButton::GetColor() { return m_color; }
