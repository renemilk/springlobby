...
ChannelChooserDialog::ChannelChooserDialog(wxWindow* parent, wxWindowID id, const wxString& title, long style)
...
void ChannelChooserDialog::ClearChannels() { m_chooser_panel->ClearChannels(); }
