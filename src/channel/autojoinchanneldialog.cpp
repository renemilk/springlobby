...
AutojoinChannelDialog::AutojoinChannelDialog(wxWindow* parent)
  ...
  m_channel_list =
      new wxTextCtrl(this, wxID_ANY, _T( "" ), wxDefaultPosition, wxDefaultSize, wxTE_MULTILINE | wxTE_DONTWRAP);
  wxSizer* buttonSizer = CreateButtonSizer(wxOK | wxCANCEL | wxALIGN_CENTRE);
  wxStaticLine* seperator = new wxStaticLine(this);
  wxStaticText* hint =
      new wxStaticText(this, -1, _("Add one channel per line like this:\n"
...
void AutojoinChannelDialog::OnCancel(wxCommandEvent& /*unused*/) { this->Show(false); }
