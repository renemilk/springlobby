...
LobbyOptionsTab::LobbyOptionsTab(wxWindow* parent)
  ...
  m_web_def_radio =
      new wxRadioButton(this, SPRING_DEFWEB, _("Default Browser."), wxDefaultPosition, wxDefaultSize, wxRB_GROUP);
  ...
  m_autoconnect_label =
      new wxStaticText(this, -1, IdentityString(_("If checked, %s will automatically log on to the last used server")));
  ...
  m_reportstats_label = new wxStaticText(
      this, -1,
      IdentityString(_("By default %s will send some statistics (OS,lobby version) to server,\nto both make helping "
                       "you in case of problems easier and inform of critical updates.\nUncheck to disable.")));
  ...
  m_disable_version_check_label =
      new wxStaticText(this, -1, IdentityString(_("By default %s will check spring version.\nCheck to disable.")));
  ...
  m_updater_label = new wxStaticText(
      this, -1, IdentityString(_(
                    "%s can check at startup if a newer version is available and automatically download it for you.")));
  ...
  m_complete_method_label = new wxStaticText(
      this, -1, _("\"Match exact\" will complete a word if there is one and only one match.\n"
  ...
  m_use_tabicons =
      new wxCheckBox(this, -1, _("Show big icons in mainwindow tabs?"), wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_x_on_all_tabs = new wxCheckBox(this, -1, _("Show close button on all tabs? (needs restart to take effect)"),
...
void LobbyOptionsTab::OnDefaultWeb(wxCommandEvent& /*unused*/) { HandleWebloc(m_web_def_radio->GetValue()); }
