...
GroupOptionsPanel::GroupOptionsPanel(wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size,
                                     long style)
  ...
  m_group_list = new wxListBox(this, GROUPS_LIST, wxDefaultPosition, wxDefaultSize, 0, NULL,
  ...
  m_remove_group_button =
      new wxButton(this, REMOVE_GROUP, _("Remove"), wxDefaultPosition, wxSize(-1, -1), wxBU_EXACTFIT);
  ...
  m_rename_group_button =
      new wxButton(this, RENAME_GROUP, _("Rename.."), wxDefaultPosition, wxSize(-1, -1), wxBU_EXACTFIT);
  ...
  m_login_notify_check =
      new wxCheckBox(m_group_panel, NOTIFY_LOGIN, _("Notify login/logout"), wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_ignore_chat_check =
      new wxCheckBox(m_group_panel, IGNORE_CHAT, _("Ignore Chat"), wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_notify_host_check =
      new wxCheckBox(m_group_panel, NOTIFY_HOST, _("Notify Hosted Battles"), wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_notify_status_check =
      new wxCheckBox(m_group_panel, NOTIFY_STATUS, _("Notify Status Change"), wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_highlight_check =
      new wxCheckBox(m_group_panel, NOTIFY_HIGHLIGHT, _("Highlight"), wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_highlight_colorstaticText =
      new wxStaticText(m_group_panel, wxID_ANY, _("Highlight Color"), wxDefaultPosition, wxDefaultSize, 0);
  m_highlight_colorstaticText->Wrap(-1);
  colorSizer->Add(m_highlight_colorstaticText, 0, wxALIGN_CENTER_VERTICAL | wxALL, 5);

  m_highlight_color_button =
      new ColorButton(m_group_panel, HIGHLIGHT_COLOR, wxColour(0, 0, 0), wxDefaultPosition, wxSize(20, 20));
  ...
  m_add_user_button =
      new wxButton(m_group_panel, ADD_USER, _("Add.."), wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT);
  m_add_user_button->SetToolTip(_("Add users to group"));

  userButtonSizer->Add(m_add_user_button, 0, wxEXPAND | wxTOP | wxRIGHT, 5);

  m_remove_user_button =
      new wxButton(m_group_panel, REMOVE_USER, _("Remove"), wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT);
