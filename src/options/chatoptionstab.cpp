...
ChatOptionsTab::ChatOptionsTab(wxWindow* parent) : wxScrolledWindow(parent, -1) {
  ...
  m_test_text =
      new wxTextCtrl(m_custom_colors, wxID_ANY,
                     _("[19:35] ** Server ** Connected to Server.\n[22:30] <Dude> hi everyone\n[22:30] ** Dude2 joined "
  ...
  m_irc_colors =
      new wxCheckBox(this, wxID_ANY, _("Enable Irc colors in chat messages"), wxDefaultPosition, wxDefaultSize, 0);
  m_irc_colors->SetValue(sett().GetUseIrcColors());

  sbBehaviorSizer->Add(m_irc_colors, 0, wxALL, 5);
#ifndef DISABLE_SOUND
  m_play_sounds =
      new wxCheckBox(this, ID_PLAY_SOUNDS, _("Play notification sounds"), wxDefaultPosition, wxDefaultSize, 0);
  m_play_sounds->SetValue(sett().GetChatPMSoundNotificationEnabled());
  sbBehaviorSizer->Add(m_play_sounds, 0, wxALL, 5);
#endif

  m_broadcast_check =
      new wxCheckBox(this, wxID_ANY, _("Copy server messages in current channel"), wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_num_lines_lbl = new wxStaticText(this, wxID_ANY, _("approx. number of lines loaded from log into chat"),
  ...
  m_hilight_words_label =
      new wxStaticText(this, wxID_ANY, _("Words to highlight in chat:"), wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_highlight_req = new wxCheckBox(this, ID_HL_REQ, _("Additionally play sound/flash titlebar "), wxDefaultPosition,
                                   wxDefaultSize, 0);
...
void ChatOptionsTab::OnRestore(wxCommandEvent& /*unused*/) { DoRestore(); }
...
void ChatOptionsTab::OnNormalSelect(wxCommandEvent& /*unused*/) { OnColorChange(m_normal_color); }

void ChatOptionsTab::OnBGSelect(wxCommandEvent& /*unused*/) { OnColorChange(m_bg_color); }

void ChatOptionsTab::OnActionSelect(wxCommandEvent& /*unused*/) { OnColorChange(m_action_color); }

void ChatOptionsTab::OnHighlightSelect(wxCommandEvent& /*unused*/) { OnColorChange(m_highlight_color); }

void ChatOptionsTab::OnJoinLeaveSelect(wxCommandEvent& /*unused*/) { OnColorChange(m_joinleave_color); }

void ChatOptionsTab::OnNotificationSelect(wxCommandEvent& /*unused*/) { OnColorChange(m_note_color); }

void ChatOptionsTab::OnMyMessSelect(wxCommandEvent& /*unused*/) { OnColorChange(m_my_color); }

void ChatOptionsTab::OnServerSelect(wxCommandEvent& /*unused*/) { OnColorChange(m_server_color); }

void ChatOptionsTab::OnClientSelect(wxCommandEvent& /*unused*/) { OnColorChange(m_client_color); }

void ChatOptionsTab::OnErrorSelect(wxCommandEvent& /*unused*/) { OnColorChange(m_error_color); }

void ChatOptionsTab::OnTimestampSelect(wxCommandEvent& /*unused*/) { OnColorChange(m_ts_color); }
