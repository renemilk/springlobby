...
const char* flag_str[] = {
    ...
    "DM", "DO", "DZ", "EC", "EE", "EG", "EH", "ER", "ES", "ET", "FAM", "FI", "FJ", "FK", "FM", "FO", "FR", "GA", "GB",
    "GD", "GE", "GF", "GH", "GI", "GL", "GM", "GN", "GP", "GQ", "GR",  "GS", "GT", "GU", "GW", "GY", "HK", "HM", "HN",
    "HR", "HT", "HU", "ID", "IE", "IL", "IN", "IO", "IQ", "IR", "IS",  "IT", "JM", "JO", "JP", "KE", "KG", "KH", "KI",
    ...
    "VA", "VC", "VE", "VG", "VI", "VN", "VU", "WF", "WS", "YE", "YT",  "ZA", "ZM", "ZW", 0};

const char* const* flag_xpm[] = {
    AD_xpm, AE_xpm, AF_xpm, AG_xpm, AI_xpm, AL_xpm, AM_xpm, AN_xpm, AO_xpm, AR_xpm, AS_xpm, AT_xpm,  AU_xpm, AW_xpm,
    AX_xpm, AZ_xpm, BA_xpm, BB_xpm, BD_xpm, BE_xpm, BF_xpm, BG_xpm, BH_xpm, BI_xpm, BJ_xpm, BM_xpm,  BN_xpm, BO_xpm,
    BR_xpm, BS_xpm, BT_xpm, BV_xpm, BW_xpm, BY_xpm, BZ_xpm, CA_xpm, CC_xpm, CD_xpm, CF_xpm, CG_xpm,  CH_xpm, CI_xpm,
    CK_xpm, CL_xpm, CM_xpm, CN_xpm, CO_xpm, CR_xpm, CS_xpm, CU_xpm, CV_xpm, CX_xpm, CY_xpm, CZ_xpm,  DE_xpm, DJ_xpm,
    DK_xpm, DM_xpm, DO_xpm, DZ_xpm, EC_xpm, EE_xpm, EG_xpm, EH_xpm, ER_xpm, ES_xpm, ET_xpm, FAM_xpm, FI_xpm, FJ_xpm,
    FK_xpm, FM_xpm, FO_xpm, FR_xpm, GA_xpm, GB_xpm, GD_xpm, GE_xpm, GF_xpm, GH_xpm, GI_xpm, GL_xpm,  GM_xpm, GN_xpm,
    GP_xpm, GQ_xpm, GR_xpm, GS_xpm, GT_xpm, GU_xpm, GW_xpm, GY_xpm, HK_xpm, HM_xpm, HN_xpm, HR_xpm,  HT_xpm, HU_xpm,
    ID_xpm, IE_xpm, IL_xpm, IN_xpm, IO_xpm, IQ_xpm, IR_xpm, IS_xpm, IT_xpm, JM_xpm, JO_xpm, JP_xpm,  KE_xpm, KG_xpm,
    KH_xpm, KI_xpm, KM_xpm, KN_xpm, KP_xpm, KR_xpm, KW_xpm, KY_xpm, KZ_xpm, LA_xpm, LB_xpm, LC_xpm,  LI_xpm, LK_xpm,
    LR_xpm, LS_xpm, LT_xpm, LU_xpm, LV_xpm, LY_xpm, MA_xpm, MC_xpm, MD_xpm, ME_xpm, MG_xpm, MH_xpm,  MK_xpm, ML_xpm,
    MM_xpm, MN_xpm, MO_xpm, MP_xpm, MQ_xpm, MR_xpm, MS_xpm, MT_xpm, MU_xpm, MV_xpm, MW_xpm, MX_xpm,  MY_xpm, MZ_xpm,
    NA_xpm, NC_xpm, NE_xpm, NF_xpm, NG_xpm, NI_xpm, NL_xpm, NO_xpm, NP_xpm, NR_xpm, NU_xpm, NZ_xpm,  OM_xpm, PA_xpm,
    PE_xpm, PF_xpm, PG_xpm, PH_xpm, PK_xpm, PL_xpm, PM_xpm, PN_xpm, PR_xpm, PS_xpm, PT_xpm, PW_xpm,  PY_xpm, QA_xpm,
    RE_xpm, RO_xpm, RS_xpm, RU_xpm, RW_xpm, SA_xpm, SB_xpm, SC_xpm, SD_xpm, SE_xpm, SG_xpm, SH_xpm,  SI_xpm, SJ_xpm,
    SK_xpm, SL_xpm, SM_xpm, SN_xpm, SO_xpm, SR_xpm, ST_xpm, SV_xpm, SY_xpm, SZ_xpm, TC_xpm, TD_xpm,  TF_xpm, TG_xpm,
    TH_xpm, TJ_xpm, TK_xpm, TL_xpm, TM_xpm, TN_xpm, TO_xpm, TR_xpm, TT_xpm, TV_xpm, TW_xpm, TZ_xpm,  UA_xpm, UG_xpm,
    UM_xpm, US_xpm, UY_xpm, UZ_xpm, VA_xpm, VC_xpm, VE_xpm, VG_xpm, VI_xpm, VN_xpm, VU_xpm, WF_xpm,  WS_xpm, YE_xpm,
    YT_xpm, ZA_xpm, ZM_xpm, ZW_xpm, 0};
