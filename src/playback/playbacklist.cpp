...
typename PlaybackList<PlaybackImp>::PlaybackType& PlaybackList<PlaybackImp>::AddPlayback(const size_t index) {
...
template <class PlaybackImp>
typename PlaybackList<PlaybackImp>::PlaybackType& PlaybackList<PlaybackImp>::GetPlaybackById(playback_id_t const& id) {
  // TODO catch
