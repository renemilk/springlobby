...
protected:
  typedef PlaybackListCtrl<PlaybackImp> ThisType;
  typedef CustomVirtListCtrl<const PlaybackImp*, PlaybackListCtrl<PlaybackImp>> ParentType;
  ...
  typedef typename ParentType::DataVector::const_iterator DataCIter; //! TODO (koshi) i'd be mighty thankful if some
                                                                     //could explain to me why the import with using
                                                                     //ParentType::DataCIter doesn't work here;
