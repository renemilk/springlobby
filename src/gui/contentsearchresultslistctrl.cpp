...
ContentSearchResultsListctrl::ContentSearchResultsListctrl(wxWindow* parent, wxWindowID id, const wxString& /*name*/,
                                                           long int /*style*/, const wxPoint& /*pt*/,
                                                           const wxSize& /*sz*/)
  : ContentSearchResultsListctrl::BaseType(parent, id, wxDefaultPosition, wxDefaultSize,
                                           ...
                                           _T("ContentSearchResultsListctrl"), 3,
                                           &ContentSearchResultsListctrl::CompareOneCrit) {
...
int ContentSearchResultsListctrl::GetItemColumnImage(long int /*item*/, long int /*column*/) const { return -1; }
int ContentSearchResultsListctrl::GetItemImage(long int /*item*/) const { return -1; }
...
void ContentSearchResultsListctrl::AddContent(ContentSearchResult*& content) { AddItem(content); }
