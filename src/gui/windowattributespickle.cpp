...
WindowAttributesPickle::WindowAttributesPickle(const wxString& name, wxTopLevelWindow* window,
                                               const wxSize& default_size)
  : m_name(name)
  , m_window(window)
...
WindowHintsPickle::~WindowHintsPickle() { SaveAttributes(); }
