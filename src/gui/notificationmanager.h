...
protected:
  ...
  typedef std::vector<UiEvents::NotficationData> EventDataBuffer;
  ...
  EventReceiverFunc<NotificationManager, UiEvents::NotficationData, &NotificationManager::OnShowNotification>
  m_showNotificationSink;
