...
SelectUsersDialog::SelectUsersDialog(wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos,
  ...
  m_filter_names_staticText =
      new wxStaticText(m_users_panel, wxID_ANY, _("Filter names"), wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_user_list = new wxListCtrl(m_users_panel, NICK_LIST, wxDefaultPosition, wxDefaultSize,
                               wxLC_REPORT | wxSUNKEN_BORDER | wxLC_SORT_ASCENDING);
...
SelectUsersDialog::~SelectUsersDialog() { ClearList(); }
...
void SelectUsersDialog::OnCancel(wxCommandEvent& /*unused*/) { EndModal(wxID_CANCEL); }

void SelectUsersDialog::OnOk(wxCommandEvent& /*unused*/) { EndModal(wxID_OK); }

wxArrayString SelectUsersDialog::GetSelection() { return GetSelectionFromText(); }
